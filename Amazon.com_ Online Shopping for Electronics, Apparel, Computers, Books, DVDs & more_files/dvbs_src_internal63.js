...
try {
	...
	dv_handler113.prototype = dv_baseHandlerIns;
dv_handler113.prototype.constructor = dv_handler113;

    var dv_handlersDefs = [{handler: new dv_handler113(), minRate: 0, maxRate: 90}];
