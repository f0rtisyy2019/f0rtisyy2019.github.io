...
(function(){
    ...
    (function() {
    var p = "3509266", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3509266||'',
    GUID:window.ftGUID_3509266||'99999999999',
    confID:window.ftConfID_3509266||'0',
    ftReturn: window.ftReturn_3509266||'',
    keyword:window.ftKeyword_3509266||'',
    ftId:window.ftId_3509266||'',
    imp:window.ftImp3509266,
    ftImpId:window.ftImp3509266 && window.ftImp3509266.impID || '',
    campaignID:'101531',
    cID:'93411',
    pID:'3509266',
    creativeID:'2446707',
    ...
    extscript:[""],
    clickTags: ["http://servedby.flashtalking.com/click/8/101531;3509266;2446707;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.xfinity.com/local/nj/jersey-city/30-mall-drive-west.html?dfaid=4053494&cmp=0&cid=4053494"],
    placementDescription:'CORPFTENGQ42018RETAILNEDNONNOTARG3509266DT300x250',
    width:300,
    height:250,
    ...
    divID:'ftdiv3509266',
    phID:'ftpos3509266',
    frameID:'ftframe3509266',
    expID:'ftexpframe3509266',
    altImgID:'ftalt3509266',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/8/101531;3509266;2446707;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.xfinity.com/local/nj/jersey-city/30-mall-drive-west.html?dfaid=4053494&cmp=0&cid=4053494',
    altImg:'http://servedby.flashtalking.com/imp/8/101531;3509266;204;gif;XfinityUS;CORPFTENGQ42018RETAILNEDNONNOTARG3509266DT300x250/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/101531;3509266;271;pixel;XfinityUS;CORPFTENGQ42018RETAILNEDNONNOTARG3509266DT300x250/?',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/350/3509266/2446707/js/j-3509266-2446707.js',
    file:'http://cdn.flashtalking.com/93411/2446707/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat8.flashtalking.com/reportV3/ft.stat?126737445-3509266;2446707;',
    adVis:false ? 1 : 0,
    centreAd:true,
    mvt:true,
    segment:window.ftSegment_3509266||'',
    segmentList:window.ftSegmentList_3509266||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp3509266 && window.ftImp3509266.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m3509266')&&/^https:/.test(document.getElementById('ftscript_m3509266').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3509266'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_3509266'],
        ['ftcfid', 'ftConfID_3509266'],
        ['fttime', 'ftTimestamp_3509266'],
        ['ftsection', 'ftSection_3509266'],
        ['ftcustom', 'ftCustom_3509266'],
        ['ft_id', 'ftId_3509266'],
        ['ftimpid','ftImp3509266', 'impID']
    ]
};
...
ft3509266.addEventListener("start",function(){
  //var usrSegs= "u0r,u0u,uyt,123".split(','),
  var usrSegs = (window.ftSegment_3509266 !== "") ? window.ftSegment_3509266.split(","): [],
   matched = [],
   getCCSegs = getCCSegs();
